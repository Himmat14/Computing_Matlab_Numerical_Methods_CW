...
set(findall(Analytical_solution,'-property','FontSize'),'FontSize',20);
...
set(findall(Euler_Sol,'-property','FontSize'),'FontSize',12);
...
set(findall(Runge_Kutta_4,'-property','FontSize'),'FontSize',12);
...
set(findall(ODE45,'-property','FontSize'),'FontSize',12);
...
set(findall(Comparison_of_methods,'-property','FontSize'),'FontSize',12);
...
set(findall(Velocity_vs_Position,'-property','FontSize'),'FontSize',12);
...
set(findall(Velocity_vs_Position2,'-property','FontSize'),'FontSize',12);
...
set(findall(error_plots,'-property','FontSize'),'FontSize',12);
...
for i = [1,2,3]
    ...
    RK4_step_study(i,1:length(time_range_step_size)) = rk_temp(1,:);
    ...
    Euler_step_study(i,1:length(time_range_step_size)) = Euler_temp(1,:);
end
...
set(findall(Euler_time_step_study,'-property','FontSize'),'FontSize',12);
...
hold on;
plot(time__step(2,:),Euler_step_study(2,:),"b-.");
hold on;
plot(time__step(3,:),Euler_step_study(3,:),"g:");
legend('\Delta t = 0.05','\Delta t = 0.005',location = 'best');
...
%set(Euler_time_step_study,"WindowState","maximized");
set(findall(Euler_time_step_study_2,'-property','FontSize'),'FontSize',12);
...
set(findall(RK4_time_step_study,'-property','FontSize'),'FontSize',12);
...
plot(time__step(1,:),RK4_step_study(1,:),"r--");
hold on;
plot(time__step(2,:),RK4_step_study(2,:),"b-.");
plot(time__step(3,:),RK4_step_study(3,:),"g:");
legend('\Delta t = 0.5','\Delta t = 0.05','\Delta t = 0.005',location = 'southeast');
...
set(findall(initil_conditions_Euler,'-property','FontSize'),'FontSize',12);
...
for i = 1:1:length(init_conditions)
    ...
    plot(Time__range,Y__Eular(i,:),'DisplayName', ['\Deltat = ' num2str(init_conditions(i))]);
...
set(findall(initil_conditions_RK4,'-property','FontSize'),'FontSize',12);
...
for i = 1:1:length(init_conditions)
    ...
    plot(Time__range,Y__RK4(i,:),'DisplayName', ['\Deltat = ' num2str(init_conditions(i))]);
...
set(findall(initil_conditions_analytical,'-property','FontSize'),'FontSize',12);
...
for i = 1:1:length(init_conditions)
    ...
    plot(Time__range,analytical_res(i,:),'DisplayName', ['\Deltat = ' num2str(init_conditions(i))]);
...
set(findall(Runge_Kutta_4_damped,'-property','FontSize'),'FontSize',12);
